...
#### ![](https://github.com/914191848/notion-import/blob/main/img/image002.png)
[](marginnoteapp://note/77FEF5F7-3C84-4F58-A7D9-CFD72F1D35AE)

### 1.1.1. 液体和气体具有易于流动的特性

#### ![](https://github.com/914191848/notion-import/blob/main/img/image004.png)
[](marginnoteapp://note/94269089-F9C0-45AE-86FF-9BA365C79979)

### 1.1.2. 流体仅仅依靠静止变形是无法在内部产生剪切应力的

#### ![](https://github.com/914191848/notion-import/blob/main/img/image006.png)
[](marginnoteapp://note/6D70CA2B-0079-4FEE-A5CF-F6393E98B24F)

### 1.1.3. 任何小的剪切力都将使流体不断变形下去

#### ![](https://github.com/914191848/notion-import/blob/main/img/image008.png)
[](marginnoteapp://note/6FD7C05A-3A3F-4F9B-BD9F-6FC8905665DC)

### 1.1.4. 斜面上固体的受力及固体静摩擦力的微观解释

#### ![](https://github.com/914191848/notion-import/blob/main/img/image010.png)
[](marginnoteapp://note/E88928AB-44CB-425B-85D1-628B42C8C10C)

### 1.1.5. 两固体间的静摩擦力是他们相接触处的分子间引力、斥力造成的

#### ![](https://github.com/914191848/notion-import/blob/main/img/image012.png)
[](marginnoteapp://note/DC9B269B-6F7E-4E6B-87EE-420EC791231A)

#### 两个分子级平滑的平面之间的摩擦力可能会很大，原因是两物体分子之间会形成一定的分子健  
![](https://github.com/914191848/notion-import/blob/main/img/image014.png)

![](https://github.com/914191848/notion-import/blob/main/img/image015.png)

#### ![](https://github.com/914191848/notion-import/blob/main/img/image017.png)
[](marginnoteapp://note/02CD719C-F71E-4A0A-9E7E-238B7EAD05B8)

### 1.1.6. 摩擦力与挤压力有关的原因是挤压力直接关系到两个接触面间的接触程度

#### ![](https://github.com/914191848/notion-import/blob/main/img/image019.png)
[](marginnoteapp://note/B0C4ABF4-AFC2-4C95-AD50-9EAAECC7ED4D)

### 1.1.7. 动摩擦力与静摩擦力不同的原因在于：动摩擦力还包括移动过程中旧键的断裂和新键的形成过程

#### ![](https://github.com/914191848/notion-import/blob/main/img/image020.png)
[](marginnoteapp://note/B15A8409-DE79-45AF-83D3-37DBA0AAC928)

#### 固液接触可以认为是两个分子级平滑的接触，但是紧挨着固体的液体分子会属于固体一起流动，所以不能仅仅通过固体位移给流体施加剪切力了  
![](https://github.com/914191848/notion-import/blob/main/img/image021.png)

#### ![](https://github.com/914191848/notion-import/blob/main/img/image023.png)
[](marginnoteapp://note/456AE87F-2D1E-4A80-8DCA-BE2E46CD4E2C)

### 1.1.8. 粘性：流体在运动状态下内部是可以产生剪切力的

#### ![](https://github.com/914191848/notion-import/blob/main/img/image025.png)
...
#### ![](https://github.com/914191848/notion-import/blob/main/img/image027.png)
...
#### ![](https://github.com/914191848/notion-import/blob/main/img/image029.png)
[](marginnoteapp://note/5DFC6786-9454-4A99-B811-B15835F1FC16)

### 1.2.2. 流体的粘性力大小基本与压力无关：原因在于流体本身已经是分子级全面接触

#### ![](https://github.com/914191848/notion-import/blob/main/img/image031.png)
[](marginnoteapp://note/9BD14B3E-6FCB-4852-8715-8D67D17AF8D4)

### 1.2.3. 液体温度越高粘性力越小  气体温度越高粘性力越大

#### ![](https://github.com/914191848/notion-import/blob/main/img/image033.png)
[](marginnoteapp://note/BDBB900B-93EB-413D-B2FB-8161E4BEA48A)

### 1.2.4. 液体分层运动，不同层之间的速度不同，邻近层之间有吸引力和排斥力，导致了动量平均 2、不同层间分子扩散

#### ![](https://github.com/914191848/notion-import/blob/main/img/image035.png)
[](marginnoteapp://note/0A06B4A0-5875-47E0-AB8C-BC66302045C2)

### 1.2.5. 分子的不规则形状使分子之间容易纠缠，而温度升高使得分子的振动增强，这种纠缠容易脱落。  
所以随着温度的升高，液体的粘性下降

#### ![](https://github.com/914191848/notion-import/blob/main/img/image037.png)
...
#### ![](https://github.com/914191848/notion-import/blob/main/img/image039.png)
[](marginnoteapp://note/AC630010-2F41-4CA9-B8B2-EC54DB9AF6DD)

### 1.3.1. 气体粘性力的本质是分子碰撞导致的动量传递。温度升高，分子碰撞的动量传递多，所以气体的粘性力升高。

#### ![](https://github.com/914191848/notion-import/blob/main/img/image041.png)
...
#### ![](https://github.com/914191848/notion-import/blob/main/img/image043.png)
[](marginnoteapp://note/DE11415F-9018-4567-A0AC-231F03374930)

### 1.3.3. 牛顿内摩擦定律：平行流动中，任意两层流体之间的切应力关系

#### ![](https://github.com/914191848/notion-import/blob/main/img/image045.png)
[](marginnoteapp://note/829697F6-D9EC-4940-9D14-577E32D35F2F)

### 1.3.4. 牛顿的流体粘性力实验

#### ![](https://github.com/914191848/notion-import/blob/main/img/image047.png)
[](marginnoteapp://note/25BCDB60-389B-4C25-80C7-57DE1D8CBB21)

### 1.3.5. 牛顿流体、非牛顿流体

#### ![](https://github.com/914191848/notion-import/blob/main/img/image049.png)
[](marginnoteapp://note/9F8D6620-E105-407E-BF83-8378F400413C)

### 1.3.6. 表面张力：气液界面上的液体分子和其他液体分子的引力不能像内部分子一样得到有效的抵消

#### ![](https://github.com/914191848/notion-import/blob/main/img/image051.png)
...
#### ![](https://github.com/914191848/notion-import/blob/main/img/image053.png)
[](marginnoteapp://note/CFB964B5-32B5-4E05-B61A-DA91A01D4C9B)

### 1.3.8. 肥皂降低了水的表面张力。肥皂泡的原理是：肥皂选择性的减弱了肥皂泡表面表面张力强的区域

#### ![](https://github.com/914191848/notion-import/blob/main/img/image055.png)
[](marginnoteapp://note/D21616D5-5397-43BF-9459-E88433E295AE)

### 1.3.9. 玻璃上水滴的受力分析

#### ![](https://github.com/914191848/notion-import/blob/main/img/image057.png)
[](marginnoteapp://note/DF10B861-E5D4-4B11-8FFB-D6E33A2765B3)

1.4. 气体的状态方程  完全气体、理想气体
-----------------------

#### ![](https://github.com/914191848/notion-import/blob/main/img/image059.png)
[](marginnoteapp://note/56FAC486-56B1-4C8A-8E9E-3DAC3659D4A0)

### 1.4.1. 气体密度的定义是单位体积气体的质量，也就是单位体积内气体分子的数量。

#### ![](https://github.com/914191848/notion-import/blob/main/img/image061.png)
[](marginnoteapp://note/775EE7C6-84DA-417C-90A0-475A34003AAF)

### 1.4.2. 温度的定义是气体分子平均动能的度量，代表了气体分子的平均速度大小

#### ![](https://github.com/914191848/notion-import/blob/main/img/image063.png)
...
#### ![](https://github.com/914191848/notion-import/blob/main/img/image065.png)
[](marginnoteapp://note/BF339152-130E-405A-A6BB-EC69B2B10FEA)

1.5. 气体的压缩性
-----------

#### ![](https://github.com/914191848/notion-import/blob/main/img/image067.png)
[](marginnoteapp://note/2A816CEA-63AF-47CB-96E3-2B5E43171828)

### 1.5.1. 温度不变时，气体密度与压力成正比，对应于气体的等温压缩或膨胀；压力不变时，密度与温度成正比，对应于气体的等压加热或冷却。

#### ![](https://github.com/914191848/notion-import/blob/main/img/image069.png)
[](marginnoteapp://note/91E00AC0-600A-4B37-9A87-B43F8E736AB9)

### 1.5.2. 气体在低于0.3Ma的流体中密度变化很小，可以按不可压处理

#### ![](https://github.com/914191848/notion-import/blob/main/img/image071.png)
...
#### ![](https://github.com/914191848/notion-import/blob/main/img/image073.png)
[](marginnoteapp://note/D4F536C7-5292-47B5-8854-9974493A8CC6)

1.6. 气体的导热性
-----------

#### ![](https://github.com/914191848/notion-import/blob/main/img/image075.png)
...
#### ![](https://github.com/914191848/notion-import/blob/main/img/image077.png)
[](marginnoteapp://note/76050032-2BC1-4E01-ABB4-DE75F4E74347)

1.8. 流体中的作用力 分为两类，一种是体积力和质量力，不需要接触；另一种是表面力，需要与物体相接触
---------------------------------------------------

#### ![](https://github.com/914191848/notion-import/blob/main/img/image079.png)
